...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <div class="input-group">
            ...
            <div class="input-group-append">
                <select name="options" id="" class="form-control">
                    <option value="" selected disabled>select search about</option>
                    @can('users')
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Alerts -->
                <span id="notify_count" class="badge badge-danger badge-counter">{{auth('admin')->user()->unreadNotifications->count() }}</span>
            </a>
            <!-- Dropdown - Alerts -->
            <div   id="notify_push" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                 aria-labelledby="alertsDropdown">

                @forelse(auth('admin')->user()->unreadNotifications as $notify)
                   ...
                   <a class="dropdown-item d-flex align-items-center" href="{{$notify->data['link']}}?notify_admin={{$notify->id}}">
                       ...
                       <div>
                           ...
                           <span class="font-weight-bold">{{$notify->data['name']}} send </span>
                           <span class="font-weight-bold">message : {{$notify->data['title']}} </span>
                       </div>
                   </a>
        ...
        @endcan
        <!-- end real time notifications using pusher  -->
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">@if(auth('admin')->check())  {{auth('admin')->user()->name}}@endif</span>
